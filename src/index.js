...
client.on("message", (message) => {
  ...
  // Xem Avatar [003]
    ...
    if(member){
         ...
         message.channel.send("Xin lỗi nhưng tôi không tìm được người này ")} }
    else {
  ...
  // Random Number [005]
    case "random":
         message.channel.send("<:D_yes:828800864344342568> Con số may mắn của bạn là: " + Math.floor(Math.random() * 1001 ));
    break;
    case "say":
